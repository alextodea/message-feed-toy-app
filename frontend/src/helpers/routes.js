...
export const GET_SINGLE_THREAD = "http://localhost:4000/threads/get-single-thread";
export const POST_THREAD = "http://localhost:4000/threads/add";
export const POST_DELETE_THREAD = "http://localhost:4000/threads/remove-single-thread"
export const POST_COMMENT = "http://localhost:4000/comments/add";
export const POST_DELETE_COMMENT = "http://localhost:4000/comments/remove-single-comment"